...
public abstract class Client implements ConnectionControl
{
	...
	/**
	 * Sendet die angegebene Nachricht an den angegebenen Empfänger.
	 * @param _message
	 */
	...
	public void removeConnectionByConnection(String useless, int notNecessary) //NICHT von extern aufrufen!!! Wird ausschließlich von der Connection verwendet 
	{
		myConnection = null;
		connectionRemoved();
	}
